...
namespace Nthware.SDS.Migrations
{
    ...
    [Migration("20250927131315_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Nthware.SDS.Authorization.Users.User", b =>
                {
                    ...
                    b.Property<long?>("AssignedOrganisationId")
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("AssignedOrganisationId");
            ...
            modelBuilder.Entity("Nthware.SDS.Domain.Organisations.Organisation", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Nthware.SDS.Domain.Technicians.Technician", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Nthware.SDS.Domain.Tickets.Ticket", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("Nthware.SDS.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("Nthware.SDS.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Nthware.SDS.Authorization.Users.User", b =>
                {
                    b.HasOne("Nthware.SDS.Domain.Organisations.Organisation", "AssignedOrganisation")
                        .WithMany("Users")
                        .HasForeignKey("AssignedOrganisationId")
                    ...
                    b.Navigation("AssignedOrganisation");
            ...
            modelBuilder.Entity("Nthware.SDS.Domain.Technicians.Technician", b =>
                {
                    b.HasOne("Nthware.SDS.Domain.Organisations.Organisation", "Organisation")
                        .WithMany("Technicians")
                        .HasForeignKey("OrganisationId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("Nthware.SDS.Authorization.Users.User", "User")
                        .WithMany()
                        .HasForeignKey("UserId");
            ...
            modelBuilder.Entity("Nthware.SDS.Domain.Tickets.Ticket", b =>
                {
                    b.HasOne("Nthware.SDS.Domain.Technicians.Technician", "AssignedTechnician")
                        .WithMany("AssignedTickets")
                        .HasForeignKey("AssignedTechnicianId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("Nthware.SDS.Authorization.Users.User", "RaisedBy")
