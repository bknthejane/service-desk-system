...
{
    public abstract class SDSWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static SDSWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(SDSWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<SDSDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<SDSDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<SDSDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<SDSDbContext, Task<T>> func)
        {
            T result;
